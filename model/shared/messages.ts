export class APIError extends Error {
    ...
    static errMissingData(properties?: any, internalProperties?: any) {
        return new APIError(
            'Missing Body',
    ...
    static errInternalServerError(properties?: any, internalProperties?: any) {
        return new APIError(
...
export class PublicInfo {
    ...
    static infoRetrieved(properties: any) {
